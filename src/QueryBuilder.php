...
use R1KO\QueryBuilder\Exceptions\QueryBuilderException;
...
class QueryBuilder implements IQueryBuilder
{
    ...
    {
        if (count($values) === 0) {
            throw new QueryBuilderException('Empty insert values');
        }
...
//            $statement->setFetchMode($mode, $this->asObject);
    ...
    public function count(?string $columnName = null): int
    {
        ...
        $columnName = $this->createRaw('COUNT(' . $columnName . ')');
    ...
    public function sum($columnName)
    {
        ...
        $columnName = $this->createRaw('SUM(' . $columnName . ')');
    ...
    public function avg($columnName)
    {
        ...
        $columnName = $this->createRaw('AVG(' . $columnName . ')');
    ...
    public function min($columnName)
    {
        ...
        $columnName = $this->createRaw('MIN(' . $columnName . ')');
    ...
    public function max($columnName)
    {
        ...
        $columnName = $this->createRaw('MAX(' . $columnName . ')');
...
*/
    ...
    public function createRaw(string $expression): RawExpression
    {
